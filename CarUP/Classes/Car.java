...
public abstract class Car {
    ...
    public Car(String make, String model, TypeCar pickup, int numberWheels, TypeFuel fuelType,TypeGearBox gearBoxType, Color bodyColor, int engineCap){
        this.make = make;
        this.model = model;
        this.bodyType = pickup;
